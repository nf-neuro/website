...
You can still catch up by following the [setup section](/pipeline/1-setup).
...
```nextflow
    ...
    manifest {
        ...
        description     = """tutorial is a Nextflow pipeline for processing neuroimaging data."""
        version         = '0.1dev'
    }
...
<RunIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden /> **Now, you can run nextflow..**
